...
.PHONY: produce-news
produce-news:
> python services/producers/finnhub_news_producer.py --symbols AAPL,MSFT,NVDA,AMZN,TSLA --max-events-per-symbol 5 --once
...
produce-finnhub-ws:
> python services/producers/finnhub_ws_producer.py --symbols AAPL,MSFT,NVDA,AMZN,TSLA,BINANCE:BTCUSDT --max-messages 20
